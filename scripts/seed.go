...
import (
	...
	"github.com/TrapLord92/Golang-Booking-Hotel-Api.git/api"
	"github.com/TrapLord92/Golang-Booking-Hotel-Api.git/db"
	"github.com/TrapLord92/Golang-Booking-Hotel-Api.git/db/fixtures"
